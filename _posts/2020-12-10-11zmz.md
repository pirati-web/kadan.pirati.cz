...
### Bod 3) - Interpelace 
**Znovu jsme vznesly námitky k zápisu z posledního jednání**, který byl velmi zkrácený, neobsahoval body, které dle jednacího řádu obsahovat má - průběh rozprav, dotazy a návrhy apod.

*Opakovaně **město není schopno zajistit online přenos a dokonce prý nepořizuje ani zvukový záznam**, přestože je obojí v rozporu se schvalovaným jednacím řádem i informacemi na webu města a do doby než jsme si o zvukový záznam požádaly bylo i běžnou praxí.*

- Již podruhé jsme od starosty dostali odpověď, že se přenos vyřeší - tak snad se dočkáme v březnu.

Jaké jsou **důvody seškrtání komunitního plánu?** 
- Starosta to odmítl řešit s tím, že se bude scvhalovat až v březnu - viz samostatný příspěvek.

Proč **byla radou jednomyslně zamítuta pomoc novému sportovnímu spolku**, který se věnuje dětem a dosahuje i lepších výsledků než jiné? 
- Na náš apel dojde k jednání.
...
Více v [samostatném příspěvku](https://kadan.pirati.cz/aktuality/gdpr.html).

Proč jsou **náklady na vlakovou dopravu pod odborem životního prostředí?**

- Protože je to (chvályhodný) koníček pana vedoucího odboru Frajta, a prý to dělá ve svém volném čase. 

Rozpočet města je pro nás stále nejasný, nesrozumitelný a netransparentní, proto jsme ho nepodpořili.

### Bod 15, 16, 22)  – Dotace na sport, pro ostatní žadatele, v sociální oblasti
Jakýkoliv pokus o narovnání systému dotací je marný - více v [samostatném příspěvku](https://kadan.pirati.cz/aktuality/dotace2.html).
...
Novým členem FV se stal pan Juha (syn interní auditorky města), studující vysokou školu v Praze. 

Prý ho to zajímá.

### Bod 33) – 2. Neuvolněný místostarosta
Druhým místostarostou se stal pan Vaic, učící na střední stavební škole. 

Nadšený z nabídky prý nebyl.

### Bod 34) - Změna jednacího řádu
Upozornili jsme, že zastupitelstvo hlasovalo **špatnou procedurou** při jednání o poslední změně jednacího řádu. 

Byl totiž schválen jen poslední protinávrh o doplnění jména města do nadpisu, ale již se nehlasovalo o předchozích protinávrzích, které upravovaly další části. Přesto je některé "upravené" části v novém jednacím řádu projevily!?

Ověřovatelé pak ale podepsali zápis z jednání zastupitelstva bez připomínek, takže je prý vše v pořádku.
**Zvukový záznam se díky té této svévolné změně nedělá, takže nejsou další důkazy ani do budoucnosti.** 
Takto si tu žijeme.
